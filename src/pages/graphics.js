    ...
    return (
        <Layout>
            <Grid>
                ...
                <div className="flex justify-center row-start-2 row-span-1 col-span-3 lg:col-span-4 mx-5 lg:mx-0 lg:col-start-3" data-aos="slide-up" data-aos-duration='800' data-aos-easing='ease-in-out-sine'>
