...
export default function Index(){
    return(
        <Layout>
            ...
            <Grid>
                <Header></Header>
                <div className='text-left mx-10 mt-10 col-start-1 col-span-3 row-start-2 text-blue'>
                    <h1 className='font-serif text-5xl animated' data-sal="fade" data-sal-duration="0">Zach Ahmed</h1>
                    <h3 className='font-sans-serif text-2xl mt-5'>A Montreal-based digital designer working to translate complex problems into elegant experiences.</h3>
                </div>

                <Link to='/about' className="row-start-4 col-start-1 col-span-2 ml-10">
                ...
                <Link to='/about' className="row-start-5 col-start-2 col-span-2 mr-10">
            ...
            <Grid>    
                ...
                <Link to='/#top' className='font-serif text-3xl row-start-4 w-screen text-center my-20 text-blue' data-sal="slide-up" data-sal-delay="0" data-sal-easing="ease-in-out-quad" data-sal-duration="200">Back to top</Link>
            </Grid>
        </Layout>       
    )
}
