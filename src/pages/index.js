    ...
    return(
        <Layout>
            ...
            <Grid>
                ...
                <Link to='/mypiece' className="row-start-4 col-start-1 col-span-2 ml-10 md:col-start-2 md:col-span-3 md:row-start-4 md:row-span-2">
                ...
                <Link to='/natureofthings' className="row-start-5 col-start-2 col-span-2 mr-10 md:col-start-5 md:row-start-4 md:col-span-3 md:row-span-2">
            ...
            <Grid>    
                <Link to='/cumulonimbus' className="row-start-1 col-start-1 col-span-2 ml-10 md:col-start-2 row-span-2 md:col-span-3">
                    <Project pTitle='Cumulonimbus' pDescription='An interactive installation designed for display at Dawson college.'/>
                </Link>

                <Link to='/graphics' className="row-start-2 col-start-2 col-span-2 mr-10 md:row-start-1 md:col-start-5 row-span-2 md:col-span-3">
                ...
                <Link to='/cannabislaws' className="row-start-3 col-start-1 col-span-2 ml-10 md:col-start-2 md:col-span-3 row-span-2">
